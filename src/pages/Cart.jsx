...
const Cart = ({pizzas, totalCount, totalPrice, groupPizzas, onClickClearCart, onClickRemovePizza, onMinusPizza, onPlusPizza}) => {
    return (
                ...
                {totalCount ?
                    <div className="cart">
                        ...
                        <div className="content__items">
                            {groupPizzas.map(pizza => {
                                return (
                                    <CartItem id={pizza.id}
                                              name={pizza.name} type={pizza.types} size={pizza.sizes}
                        ...
                        <div className="cart__bottom">
                            ...
                            <div className="cart__bottom-buttons">
                                <NavLink to="/main" className="button button--outline button--add go-back-btn">
